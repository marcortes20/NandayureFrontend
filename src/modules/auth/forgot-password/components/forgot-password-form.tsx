  ...
  return (
    <form onSubmit={onSubmit}>
      {!emailSent ? (
        ...
        <>
          <h5 className={`${titleFont.className} mb-3 text-base text-center font-semibold text-gray-900 md:text-xl`}>
            Correo enviado
          </h5>
          <p className="text-center text-sm text-gray-700 mt-4">
            Revisa tu correo electrónico para un enlace para restablecer tu contraseña. Si no aparece en unos minutos, revisa tu carpeta de spam.
          </p>
        </>
      )}
      <section>
